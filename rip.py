...
class BDRip:
    ...
    encoder_settings = [
        'default', 'film', 'animation', 'grain', 'psnr', 'ssim', 'fast_decode'
    ]
    encoder_crf = 20

    # Template directory
    directory = os.path.normpath(
        "C:/Users/JamesTheBard/Code/python-bdtools/templates"
    )
    template = {}
    ...
    tool_path = "C:/Program Files (x86)/MeGui/tools"
    ...
    def createAvsFromTemplate(self, **kwargs):
        ...
        if "source_type" not in kwargs.keys():
            raise SourceNotDefinedError(
                "The keyword argument 'source_type' is not defined."
            )
